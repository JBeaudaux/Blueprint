...
\LRH{J. Beaudaux et~al.}

\RRH{Blue print: an open life-logging system for improved health management}
...
\title{Blue print: an open life-logging system for improved health management}


\authorA{Julien Beaudaux}
\affA{Department of Telematics,\\Norwegian University of Science and Technology (NTNU),\\ Trondheim, Norway \\
E-mail: julien.beaudaux@item.ntnu.no}

\authorB{Yuming Jiang}
\affB{Department of Telematics,\\Norwegian University of Science and Technology (NTNU),\\ Trondheim, Norway \\
E-mail: jiang@item.ntnu.no}

\begin{abstract}

%The main impediments to further advance in the identification of determinants and pathways characteristic of ageing, is the lack of an overview both horizontally across population and longitudinally across time about their joint impact and interactions on health and disease. Building on the recent advances in data mining, cloud computing and the Internet of things and by combining expertises in different disciplines, MAIDAN aims at developing an integrated concept able to improve the ability to computationally model, monitor and analyse health and disease, from early stages of development onwards. To complete this task, the impact of biological, behavioural, environmental and nutritional factors on metabolic parameters playing a role in ageing will be evaluated through the joint metrics analysis of the gathered knowledge of animals and humans. This way, a model depicting the mechanisms underlying health and disease as well as a disease risk-factors and predictors matrix will be established. Finally, in order to provide the evidence needed to improve and validate this model, a sustainable and generalisable life-logging concept will be designed for fine-grained long-standing cohort studies. Factors such as non-intrusivity, privacy, modularity, cost and user input aspects will also play a key role in its design to ensure optimal user acceptance and wide use of the system by medical research laboratories and care services. This way, we envision that the MAIDAN project will trigger future long-standing cohort studies and enable further advances in the understanding of health and disease development in ageing.
\end{abstract}

\KEYWORD{Life-logging; open-source software; Internet of Things; Understanding health, ageing and disease.}

\REF{to this paper should be made as follows: Beaudaux, J. and Jiang, Y. (2015) `Blue print: an open life-logging system for improved health management', {\it International Journal of Electronic Healthcare}, Vol. x, No. x, pp.xxx\textendash xxx.}

\begin{bio}

Julien Beaudaux received his PhD in Computer Science at the University of Strasbourg, France, and is now a postdoctoral researcher at the NTNU Trondheim (Norway).
His interests include wireless sensors, the Internet of things (IoT), and their applications in the fields of telemedicine and home-care. He has authored and co-authored over 10 scientific papers in this field. He is also involved in several open projects, including the IoT-LAB experimentation platform for the Internet of things and the TAMIAS open-source privacy-aware storage system.

\noindent Yuming Jiang
\end{bio}
...
Over the past decade, computer science has revolutionised medicine by \dots . However, little has been done to improve the provided care for patients outside the range medical structures. Indeed, patients still have to rely on regular visitations of medical personnel.
Paralelly, little is known about people's lifestyle and their correlation with health and disease evolution.
...
\bibitem[\protect\citeauthoryear{Fontana et al.}{2014}]{nature10age} Fontana, L., Kennedy, B.K., Longo, V.D, Seals, D. and Melov, S. (2014) 'Medical research: Treat ageing', {\it Nature}, Vol. 511, No. 7510, pp. 405--407
